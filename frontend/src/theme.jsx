...
function modeTokens(mode) {
  ...
  return {
    ...
    acid: ACID,
    onBlue: '#f8f7f2',
    warm: dark ? '#f1ede4' : '#f8f7f2',
    warmMuted: dark ? '#d7cfc1' : '#e9e6de',
    ...
    secondary: dark ? '#d7cfc1' : '#c7d600',
    secondaryLight: dark ? '#f1ede4' : '#f4ff86',
    secondaryDark: dark ? '#b6ab99' : '#aebc00',
    ...
    headerLine: dark ? 'rgba(170,177,255,0.38)' : 'rgba(248,247,242,0.42)',
    ...
    hover: dark ? 'rgba(241,237,228,0.07)' : 'rgba(0,0,242,0.085)',
    line: dark ? 'rgba(170,177,255,0.24)' : 'rgba(0,0,242,0.3)',
    lineStrong: dark ? 'rgba(170,177,255,0.46)' : 'rgba(0,0,242,0.48)',
    text: dark ? '#f1ede4' : '#0000c8',
    textSecondary: dark ? '#aaa7af' : '#4d4db0',
  ...
  return {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        '::selection': { backgroundColor: tokens.secondary, color: HERMES_BLUE },
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedPrimary: {
          backgroundColor: mode === 'dark' ? tokens.warm : tokens.primary,
          color: mode === 'dark' ? HERMES_BLUE : tokens.onBlue,
          border: `1px solid ${mode === 'dark' ? tokens.warm : tokens.primary}`,
          '&:hover': { backgroundColor: mode === 'dark' ? tokens.warmMuted : tokens.primaryDark, color: mode === 'dark' ? HERMES_BLUE : tokens.onBlue, borderColor: mode === 'dark' ? tokens.warmMuted : tokens.primaryDark },
        },
    ...
    MuiTooltip: {
      ...
      styleOverrides: { tooltip: { backgroundColor: tokens.warm, color: HERMES_BLUE, border: `1px solid ${mode === 'dark' ? tokens.lineStrong : HERMES_BLUE}`, fontFamily: tokens.monoFont, fontWeight: 700 }, arrow: { color: tokens.warm } },
    },
  };
}
