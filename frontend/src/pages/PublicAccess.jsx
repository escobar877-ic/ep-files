...
function PublicShell({ title, ownerEmail, error, children }) {
  return (
    <Box className="ep-page" sx={{ minHeight: '100vh', backgroundColor: 'background.default', color: 'text.primary' }}>
      <Box sx={{ minHeight: 86, display: 'grid', placeItems: 'center', bgcolor: (theme) => theme.ep.header, borderBottom: '1px solid', borderColor: (theme) => theme.ep.headerLine }}><BrandWordmark inverse /></Box>
